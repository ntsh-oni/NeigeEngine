...
inline VkSampler trilinearOffscreenSampler = VK_NULL_HANDLE;
inline VkSampler trilinearLodOffscreenSampler = VK_NULL_HANDLE;
inline VkSampler nearestOffscreenSampler = VK_NULL_HANDLE;
inline VkSampler nearestRepeatOffscreenSampler = VK_NULL_HANDLE;
inline VkSampler shadowSampler = VK_NULL_HANDLE;
