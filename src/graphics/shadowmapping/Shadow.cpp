...
void Shadow::init() {
	...
	ImageTools::createImageView(&defaultShadow.imageView, defaultShadow.image, 0, 1, 1, VK_IMAGE_VIEW_TYPE_2D, physicalDevice.depthFormat, VK_IMAGE_ASPECT_DEPTH_BIT);
